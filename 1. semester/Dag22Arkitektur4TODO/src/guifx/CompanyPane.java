...
public class CompanyPane extends GridPane {
	...
	public CompanyPane() {
		...
		Button btnCC = new Button("Create Customer");
		hbxButtons.getChildren().add(btnCC);
		btnCC.setOnAction(event -> this.createCustomer());
		
		Button btnCustomers = new Button("View Customer");
		hbxButtons.getChildren().add(btnCustomers);
		btnCustomers.setOnAction(event -> this.viewCustomers());
...
//		lvwCompanies.getSelectionModel().select(index);
	...
	public void viewCustomers() {
		...
		if (company != null) {
		CustomerViewWindow dia = new CustomerViewWindow("View All Customers", company);
		dia.showAndWait();
		updateControls();
	}
	}
