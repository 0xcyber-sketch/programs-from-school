...
public class SwimmerApp {
    ...
    public static void main(String[] args) {
        ...
        s3.setTrainingsPlan(t2);
        System.out.println(s3.getTraningsPlan().getLevel());
        s1.setTrainingsPlan(t1);
        System.out.println(s1.getTraningsPlan().getLevel());
        s2.setTrainingsPlan(t1);
        System.out.println(s2.getTraningsPlan().getLevel());
        
//        System.out.println(s3.allTrainingHours());
//        System.out.println(s2.allTrainingHours());
        
        for (Swimmer s : swimmers) {
        	System.out.println(s.allTrainingHours());
        }
