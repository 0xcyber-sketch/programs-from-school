...
public class Konference {
	...
	public Konference(String navn, String beskrivelse, String adresse, double pris, LocalDateTime startDato,
	...
	public Udflugt createUdflugt(String sted, LocalDateTime startTid, double pris, String beskrivelse) {
		Udflugt udflugt = new Udflugt(sted, beskrivelse, pris, startTid);
