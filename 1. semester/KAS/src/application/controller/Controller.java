...
public class Controller {
	...
	public static Konference createKonference(String navn, String beskrivelse, LocalDateTime startDato, String adresse,
		...
		Konference k1 = new Konference(navn, beskrivelse, adresse, pris, startDato, slutDato);
	...
	public static Hotel createHotel(double prisEnkeltVærelse, String navn, String adresse, double prisDobbeltVærelse) {
		Hotel h1 = new Hotel(navn, adresse, prisEnkeltVærelse, prisDobbeltVærelse);
		Storage.addHotel(h1);
		return h1;
	}
	...
	public static Tilmelding createTilmelding(LocalDate ankomstDato, LocalDate afrejseDato, Deltager deltager,
		...
		Tilmelding t1 = new Tilmelding(deltager, konference, ankomstDato, afrejseDato);
	...
	public static void removeDeltagerFromTilmelding(Tilmelding tilmelding) {
		tilmelding.setDeltager(null);
	}
	
	public static void deleteTilmelding(Tilmelding tilmelding) {
		Controller.removeTilmeldingFromKonference(tilmelding, tilmelding.getKonference());
	}
